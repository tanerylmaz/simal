                ...
                <div className="col-md-10 col-lg-8 mb-4" style={{ marginTop: '87px' }}>
                    <div className="card shadow-sm border-0">
                        ...
                        <div className="card-body">
                            <h3 className="card-title fw-bold mb-3 text-center">İfraz - Tevhid Hizmetleri</h3>

                            <p> Parselin bölünerek ayrılması işlemi ifraz, parselleri birbirinden ayırmak ve arazi ile arsa düzenlemesine uygun olarak planla belirlenen parselin ifraz edileceği hatta da ifraz hattı deniyor. Tevhit ise parsellerin birleştirilme işlemi oluyor. Yeni yönetmelik kapsamında ifraz ve birleştirme işlemlerine yönelik açıklamalar bulunuyor.</p>

                            <p>Parselasyon planı bulunan yerlerde, daha sonrasında plan değişikliği veya revizyonu yapılması halinde bu planlar ile belirlenen; umumi hizmet alanına isabet eden taşınmazlar ile bayındır istikameti önünde kalan donatı alanları, kamu eline geçmeden birleştirme ve salgı yapılamaz.</p>

                            <p>Bir bayındır adasında, mevzuatına uygun binalar dikkate alınarak ve yeni inşa edilecek binaların şematik konumu çizilerek ada bazında etüt yapılıp, ada içindeki parsel dağılımının yapıların estetiği ve sokak siluetini bozmayacak şekilde olduğu ortaya konulmadan, ifraz ve tevhit işlemi yapılamaz.</p>
                            <p>
