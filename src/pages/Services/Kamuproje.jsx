                ...
                <div className="col-md-10 col-lg-8 mb-4" style={{ marginTop: '87px' }}>
                    <div className="card shadow-sm border-0">
                        ...
                        <div className="card-body">
                            <h3 className="card-title fw-bold mb-3 text-center">KAMU PROJELERİ</h3>
                            <p>
                            ...
                            <h5 className="text-lg font-bold">
                                <strong className="text-red-500">TÜRK KAMU ALIMLARI SİSTEMİNİN KISA TARİHÇESİ VE KAMU İHALE KURUMUNUN KURULMASI</strong>
                            </h5>
                            ...
                            <h5 className="text-lg font-bold">
                                <strong className="text-red-500">5812 SAYILI KANUN’LA KAMU İHALE KURUMUNA VERİLEN BAZI YENİ GÖREV VE YETKİLER</strong>
                            </h5>
                            <p>
